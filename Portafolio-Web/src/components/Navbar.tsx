...
const utilityIcons: IconLink[] = [
  // Puedes añadir iconos de utilidad aquí si los necesitas, con tamaño w-6 h-6
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a href="#resume" className="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
              Resume
            </a>
          </div>
        </div>
